...
class Static {
    ...
    handleRequest(req, res) {
        ...
        res.setHeader("Content-Security-Policy", "default-src 'self'; style-src fonts.googleapis.com 'self'; font-src fonts.gstatic.com; script-src cloudflare.com jquery.com");
